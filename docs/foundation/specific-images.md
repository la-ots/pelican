...
<div class="row">
  <div class="col-12 col-md-3 text-center">
    ...
    <img class="img-fluid" alt="Louisiana State Seal." src="/img/Louisiana-State-Seal.svg">
  </div>
  <div class="col-12 offset-md-1 col-md-3 text-center">
    <p><span class="badge badge-ui">PNG</span></p>
    <img class="img-fluid" alt="Louisiana State Seal." src="/img/Louisiana-State-Seal.png" >
  </div>
</div>
